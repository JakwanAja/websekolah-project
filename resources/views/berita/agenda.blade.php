...
@section('title', 'Agenda Sekolah - SMA Negeri Unggulan')

@section('content')
<!-- Hero Section -->
<section class="page-hero" style="background: linear-gradient(135deg, #ffc107 0%, #e0a800 100%); padding: 80px 0 60px;">
    <div class="container">
            ...
            <div class="col-lg-8">
                <div class="hero-content text-dark">
                    <nav aria-label="breadcrumb" class="mb-3">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('home') }}" class="text-dark opacity-75">Home</a></li>
                            <li class="breadcrumb-item"><span class="text-dark opacity-75">Berita</span></li>
                            <li class="breadcrumb-item active text-dark">Agenda Sekolah</li>
                        </ol>
                    </nav>
                    <h1 class="display-4 fw-bold mb-3">Agenda Sekolah</h1>
                    <p class="lead mb-0">Jadwal kegiatan dan acara penting di SMA Negeri Unggulan</p>
                </div>
            </div>
            <div class="col-lg-4 text-end">
                <div class="hero-stats">
                    <div class="stat-item bg-white bg-opacity-20 rounded p-3 mb-3">
                        <h3 class="h4 text-dark mb-1">{{ $totalContents }}</h3>
                        <span class="text-dark opacity-75 small">Total Agenda</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-8">
                ...
                <div class="content-filters mb-4">
                    <div class="row align-items-center">
                        <div class="col-lg-6">
                            <form method="GET" action="{{ route('berita.agenda') }}" class="search-form">
                        ...
                        <div class="col-lg-6 text-lg-end">
                            <div class="content-count text-muted">
                                Menampilkan {{ $contents->count() }} dari {{ $contents->total() }} agenda
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <article class="content-card h-100 shadow-sm border-0 rounded-3 overflow-hidden">
                                <div class="content-image position-relative">
                                    ...
                                    <div class="content-overlay position-absolute top-0 start-0 w-100 h-100 d-flex align-items-end p-3"
                                        ...
                                        <span class="content-category bg-warning text-dark px-2 py-1 rounded small">
                                            <i class="fas fa-calendar-alt me-1"></i>{{ $content->category_display }}
                                        </span>
                                    </div>
                                </div>
                ...
                @else
                    ...
                    <div class="empty-state text-center py-5">
                        ...
                        <h4 class="text-muted mb-2">Belum Ada Agenda</h4>
                        <p class="text-muted">
                            @if(request('search'))
                                Tidak ditemukan agenda dengan kata kunci "{{ request('search') }}"
                            @else
                                Agenda sekolah akan segera ditampilkan di sini.
                            @endif
                        </p>
                        @if(request('search'))
                            <a href="{{ route('berita.agenda') }}" class="btn btn-warning">
                                Lihat Semua Agenda
                            </a>
                        @endif
                    </div>
                ...
                <div class="widget mb-4">
                    <div class="widget-header bg-warning text-dark p-3 rounded-top">
                        <h5 class="widget-title mb-0">
                            <i class="fas fa-fire me-2"></i>Agenda Terpopuler
                        </h5>
                    </div>
                    <div class="widget-body bg-white border border-top-0 rounded-bottom p-3">
                        ...
                        @empty
                            <p class="text-muted mb-0">Belum ada agenda populer.</p>
                        @endforelse
                    </div>
                </div>
                    ...
                    <div class="widget-body bg-white border border-top-0 rounded-bottom p-3">
                        <div class="category-list">
                            <div class="category-item d-flex justify-content-between align-items-center mb-2">
                                <a href="{{ route('berita.today') }}" class="text-decoration-none">
