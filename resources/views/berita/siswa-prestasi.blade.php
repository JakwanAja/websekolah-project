...
@section('title', 'Siswa Prestasi - SMA Negeri Unggulan')

@section('content')
<!-- Hero Section -->
<section class="page-hero" style="background: linear-gradient(135deg, #28a745 0%, #1e7e34 100%); padding: 80px 0 60px;">
    <div class="container">
                ...
                <div class="hero-content text-white">
                    <nav aria-label="breadcrumb" class="mb-3">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active text-white">Siswa Prestasi</li>
                        </ol>
                    </nav>
                    <h1 class="display-4 fw-bold mb-3">Siswa Prestasi</h1>
                    <p class="lead mb-0">Pencapaian membanggakan siswa-siswi SMA Negeri Unggulan</p>
                </div>
            </div>
            <div class="col-lg-4 text-end">
                <div class="hero-stats">
                    <div class="stat-item bg-white bg-opacity-10 rounded p-3 mb-3">
                        ...
                        <span class="text-white-75 small">Total Prestasi</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-8">
                ...
                <div class="content-filters mb-4">
                    <div class="row align-items-center">
                        <div class="col-lg-6">
                            <form method="GET" action="{{ route('berita.siswa-prestasi') }}" class="search-form">
                        ...
                        <div class="col-lg-6 text-lg-end">
                            <div class="content-count text-muted">
                                Menampilkan {{ $contents->count() }} dari {{ $contents->total() }} prestasi
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <article class="content-card h-100 shadow-sm border-0 rounded-3 overflow-hidden">
                                <div class="content-image position-relative">
                                    ...
                                    <div class="content-overlay position-absolute top-0 start-0 w-100 h-100 d-flex align-items-end p-3"
                                        ...
                                        <span class="content-category bg-success text-white px-2 py-1 rounded small">
                                            <i class="fas fa-star me-1"></i>{{ $content->category_display }}
                                        </span>
                                    </div>
                                </div>
                ...
                @else
                    ...
                    <div class="empty-state text-center py-5">
                        ...
                        <h4 class="text-muted mb-2">Belum Ada Prestasi</h4>
                        <p class="text-muted">
                            @if(request('search'))
                        ...
                        @if(request('search'))
                            <a href="{{ route('berita.siswa-prestasi') }}" class="btn btn-success">
                ...
                <div class="widget mb-4">
                    <div class="widget-header bg-success text-white p-3 rounded-top">
                        <h5 class="widget-title mb-0">
                            <i class="fas fa-fire me-2"></i>Prestasi Terpopuler
                        </h5>
                    </div>
                    <div class="widget-body bg-white border border-top-0 rounded-bottom p-3">
                        ...
                        @empty
                            <p class="text-muted mb-0">Belum ada prestasi populer.</p>
                        @endforelse
                    </div>
                </div>
