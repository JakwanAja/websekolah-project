    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <h6 class="text-primary">Ketentuan Password:</h6>
                    <ul class="text-sm">
                    ...
                    <h6 class="text-primary">Role yang Tersedia:</h6>
                    <ul class="text-sm">
                        <li><strong>Super Admin:</strong> Akses penuh ke semua fitur</li>
                        <li><strong>Admin:</strong> Akses terbatas untuk mengelola konten</li>
                    </ul>
                    
                    <hr>
                    
                    <h6 class="text-primary">Status User:</h6>
                    <ul class="text-sm">
                        <li><strong>Active:</strong> User dapat login dan mengakses sistem</li>
